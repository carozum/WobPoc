            ...
            <div class=" container">
                <div class="row text-dark">
                    <div class="col-lg-8 col-md-9 mx-auto">
                        ...
                        <p class="lead text-dark">Pourquoi parler de visibilité ? <br> Parce que dans le monde digital actuel, votre besoin premier est d'être vu, d'être trouvé quand on vous cherche! C'est à cette condition que vous gagnerez de la renommée, des contacts ou de l'argent.</p>
                        <p class="lead text-dark">Comment fait-on pour acquérir de la visibilité sur internet ? </p>
                        <p class="lead text-dark">Webcome on Board vous
                            propose de vous
